          ...
          Row(
            ...
            children: <Widget>[
              ElevatedButton(onPressed: () {
                Navigator.push(context, MaterialPageRoute(builder: (context) => const GcdAb()));
              }, child: const Text('GCD(A , B)')),
            ],
          ),
          ElevatedButton(onPressed: () {
              Navigator.push(context, MaterialPageRoute(builder: (context) => const XModN()));
          }, child: const Text('X\u207B\u00B9 MOD N')),
          ElevatedButton(onPressed: () {
              Navigator.push(context, MaterialPageRoute(builder: (context) => const AbModN()));
          }, child: const Text('A\u1d2e MOD N')),
          ElevatedButton(onPressed: () {
              Navigator.push(context, MaterialPageRoute(builder: (contet) => const Factorize()));
